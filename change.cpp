...
int main() {
    ...
    string content = "i am playing with football. football is soft";
    ...
    cout << "Frequency of 'football': " << wordCount["football"] << " times" << endl;
    cout << "Frequency of 'playing':   " << wordCount["playing"] << " times" << endl;
    cout << "Frequency of 'am': " << wordCount["am"] << " time" << endl;

    // --- STEP 5: Search for a Word ---
    string searchTarget = "with";
